...
export default function Component({ onFilesChange }: { onFilesChange: (files: FileWithPreview[]) => void; }) {
  ...
  const [
    ...
    maxFiles,
    maxSize,
    onFilesChange: onFilesChange, // Pass the prop directly to the hook
  });
